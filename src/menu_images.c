/* -------------------------------------------------------------------------------------- *\
	...
	Implements <program>:: Menu buttons select option
   ...
   ----------------------------------------------------------------
	...
	Modified:			9/6/13	- adapted for Nickleodeon app
   ----------------------------------------------------------------
...
// --------------------------------------------------------
void menu_images_show_window() {

    window_stack_push(&window, true);

}  // menu_calc_show_window()
...
static void clicked_select(ClickRecognizerRef recognizer, void *context) {
	...
	animation_bank_set(pending_buttons);
	update_image();
...
// -------------------------------------------------
	...
	pending_buttons = animation_bank_get();
